...
VALUES
    ...
    ('DEMO / SYNTHETIC DATA — Buyer 21', 'DEMO_SYNTHETIC', '{"Whittlesea"}', '{"RESIDENTIAL_LAND"}', 30000, 170000, 12000000, 48000000, 'MEDIUM', 'STRONG', '2026-08-25', true),
    ('DEMO / SYNTHETIC DATA — Buyer 22', 'DEMO_SYNTHETIC', '{"Whittlesea","Hume"}', '{"INDUSTRIAL_LAND","MIXED_USE"}', 15000, 90000, 7000000, 26000000, 'HIGH', 'MODERATE', '2026-06-18', true),
    ('DEMO / SYNTHETIC DATA — Buyer 23', 'DEMO_SYNTHETIC', '{"Whittlesea"}', '{"COMMERCIAL"}', 2500, 18000, 3000000, 11000000, 'LOW', 'WEAK', '2026-03-02', true);
